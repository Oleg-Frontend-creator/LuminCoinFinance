...
class OperationList {
    ...
    fillOperationTable(data) {
        return __awaiter(this, void 0, void 0, function* () {
            const operations = yield this.getOperations(data);
            const operationsListElement = document.getElementById('operations-list');
    ...
    deleteOperation() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let result;
            if (id) {
                result = yield http_utils_1.HttpUtils.request('/operations/' + id, 'DELETE', true);
                if (result && result.error) {
                    this.modalElement.style.display = 'none';
                    return console.log("Не удалось удалить операцию, обратитесь к администратору");
                }
                (_a = document.getElementById('tr-' + id)) === null || _a === void 0 ? void 0 : _a.remove();
            }
            this.modalElement.style.display = 'none';
        });
    }
